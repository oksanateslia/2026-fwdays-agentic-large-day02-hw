...
description: Read-only exploration of unfamiliar Excalidraw monorepo areas — map files, data flow, and dependencies before changing code. Use when the user says explore, investigate, or asks how X works.
---
